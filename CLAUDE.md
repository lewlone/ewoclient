...
- **Indium / Distant Horizons / Continuity not yet bundled.** Indium would unblock rendering-API-extension mods (Continuity in particular), but **Indium upstream stalled at MC 1.21.1** (latest release `1.0.36+mc1.20.1` published 2025-02-25; no MC 26.x build exists). Until Indium ships for 26.x there's nothing to bundle here. Distant Horizons + Continuity bundling is mechanical once their MC 26.1 builds stabilize — same plumbing as the four already shipping.
