...
| 36 | `explode` | handled | `req!` → `cb_play_explode` | **M68** the physics prefix, **M161** the tail and its sound. §4 partial only for the weighted list's contents, which belong to the explosion-particle tracker. |
