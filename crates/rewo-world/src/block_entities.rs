...
pub const TYPE_TABLE: &[(&str, BlockEntityKind)] = &[
    ...
    // Woodwork, cloth, base colour and up to 16 dyed layers (M28c).
...
impl SignFace {
    ...
    /// built four `String`s per face per frame — but M163's first draft called
    ...
    /// hidden — see `REWO_PLAN.md` §15's M163 entry.
