//! `ParticleTypes.STREAM_CODEC`'s per-type options, as shapes (M161).
//!
...
//! 23rd option-bearing type**, which is exactly the failure trap 19 of the M161
//! spec names.
//!
...
mod tests {
    ...
    ///
    /// The M161 spec's own trap list contradicted itself here — "the walker is
