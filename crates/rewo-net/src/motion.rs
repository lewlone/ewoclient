...
/// ~125 option codecs". **That was wrong by about 10x** (M161). Measured
...
/// The three fields [`read_explode`] stops before (M161).
...
/// Decode an `explode` body **including** the tail (M161).
///
...
/// `handleExplosion`'s first statement, as a value (M161).
///
/// ```java
