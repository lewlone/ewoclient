...
pub struct MotionStats {
    ...
    /// …whose TAIL was consumed to the last byte (M162).
    ///
...
impl PlaySession {
    ...
    /// `gameRenderer.mainCamera()`, as much of it as Rewo has (M162).
    ///
    ...
    /// The particle registry this session decodes against (M162).
    ///
    ...
    /// above", and it has had two production callers since M143** (M162 found
    ...
    /// to check.
    ///
    /// M162 moved the SOUND out of this packet's handling and into
    ...
    /// than there. (It briefly did not: M162's first commit fused it onto the
