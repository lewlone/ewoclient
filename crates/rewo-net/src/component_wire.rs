...
///
/// **It has NO production caller.** M163 moved the last four onto
...
/// it must move both.
///
/// # What still flattens with no language table after M163, and why
///
...
///
/// M163 moved the four **rendered** paths onto the resolving flatten — the
...
#[cfg(test)]
mod tests {
    /// M163: the name components are carried unflattened, so a test that used
    ...
    //
    // The FOURTH thing M163's own census called a flattener was not a fourth
    ...
    ///
    /// M163's first draft of this doc asserted the opposite — that a
    ...
    ///
    /// M163's headline finding was a census — "there are four flatteners"
    ...
    fn the_four_spellings_of_the_flatten_agree() {
        ...
        for tag in [
            ...
            // the pair M163 duplicated byte for byte.
            assert_eq!(
