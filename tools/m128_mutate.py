...
BATTERIES = {
    ...
    "e": (
        ...
        [
            ...
            (SCREEN, "                self.is_draft = false;\n                ChatClick::Handled",
                     "                ChatClick::Handled",
                     "KILLED", "a suggest_command does not clear the draft flag"),
            (SCREEN, "        self.dispatch_click_event(event)\n    }",
                     "        let o = self.dispatch_click_event(event);\n        self.is_draft = false;\n        o\n    }",
                     "KILLED", "every consumed click clears the draft flag"),
