...
- The **chat decoration** — `boundChatType.decorate`, which turns a message into `<Steve> hi`. Both halves of its old blocker (the `chat_type` registry, the language table) are now reachable.
